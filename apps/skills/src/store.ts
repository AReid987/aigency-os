...
export class SkillsStore {
  ...
  validateSkill(id: string): { valid: boolean; issues: string[] } {
  ...
  seed(): void {
    if (this.skills.size > 0) return; // Already seeded
    ...
    const demoSkills: Omit<Skill, 'id'>[] = [
      {
        ...
        description:
          'Automated deployment pipeline skill that integrates with CI/CD systems. Supports blue-green deployments, canary releases, and automatic rollback on failure metrics.',
        category: 'devops',
        version: '2.1.0',
      ...
      },
      {
        ...
        description:
          'Real-time sentiment analysis skill using LLM-powered classification. Analyzes customer feedback, support tickets, and social media mentions to provide actionable insights.',
        category: 'ai',
        version: '1.3.2',
      ...
      },
      {
        ...
        description:
          'Two-way Slack integration for sending notifications, receiving commands, and creating interactive workflows directly from Slack channels.',
      ...
      },
      {
        ...
        description:
          'ML-powered revenue forecasting skill that analyzes historical data, pipeline health, and market signals to predict future revenue with confidence intervals.',
        category: 'analytics',
        version: '1.0.0',
      ...
      },
      {
        ...
        description:
          'Visual workflow builder and orchestrator skill. Create complex multi-step workflows with conditional branching, parallel execution, and error handling.',
        category: 'workflow',
        version: '2.5.0',
